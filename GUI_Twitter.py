...
class Coin():
    def __init__(self):
        ...
        gap = Label(window, text='', background='#FFFFCB').grid(column=0, row=1)
        gap = Label(window, text='', background='#FFFFCB').grid(column=1, row=1)
        gap = Label(window, text='', background='#FFFFCB').grid(column=3, row=1)
        gap = Label(window, text='', background='#FFFFCB').grid(column=1, row=3)


        pennies = Label(window, text='No. of Tweets (10-100): ', background='#FFFFCB').grid(column=0, row=2)
        ...
        tweets1 = Entry(window, width=12, background='#FFFFCB')
        ...
        pennies = Label(window, text='Twitter Data status: ', background='#FFFFCB').grid(column=2, row=2)
        ...
        pennies2 = Label(window, text='', background='#FFFFCB')
        ...
        button_twitter = Button(window, text='Twitter Pull', command=compute,
                                bg='#FFFFCB', activebackground='#FFFFCB',
